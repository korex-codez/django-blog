...
def home(request):
    ...
    # ⚡ Performance optimization: Use select_related and prefetch_related to eliminate N+1 queries
    # for author, category, and tags when rendering post cards in templates.
...
class PostListView(ListView):
    ...
    def get_queryset(self):
        # ⚡ Performance optimization: Eagerly fetch foreign keys and M2M tags to prevent N+1 queries during list render
...
def profile_view(request, username=None):
    ...
    # ⚡ Performance optimization: Add select_related and prefetch_related to avoid N+1 queries when displaying post author/category/tags
...
def search_posts(request):
    ...
    # ⚡ Performance optimization: Eagerly load author, category, and tags for search results
...
def category_posts(request, slug):
    ...
    # ⚡ Performance optimization: Eagerly load author, category, and tags for category listing
...
def tag_posts(request, slug):
    ...
    # ⚡ Performance optimization: Eagerly load author, category, and tags for tag listing
...
def bookmarks_view(request):
    ...
    # ⚡ Performance optimization: Eagerly load author, category, and tags for bookmarked posts
    bookmark_posts = Post.objects.filter(bookmarks=request.user, status='published').select_related('author', 'category').prefetch_related('tags')
