...
def home(request):
    ...
    # ⚡ Bolt Optimization: Use select_related and prefetch_related to eliminate N+1 queries for author, category, and tags
...
class PostListView(ListView):
    ...
    def get_queryset(self):
        # ⚡ Bolt Optimization: Use select_related and prefetch_related to eliminate N+1 queries when rendering posts in home.html
